...
//  usuarios
//
//  Created by Rafael Calvillo Sanchez on 28/5/15.
//  Copyright (c) 2015 Rafael Calvillo Sanchez. All rights reserved.
//
...
+ (NSString *) getPasswordForUsername: (NSString *) username andServiceName: (NSString *) serviceName error: (NSError **) error {
    ...
    CFRelease((__bridge CFTypeRef)(attributeQuery));
    ...
    CFRelease((__bridge CFTypeRef)(passwordQuery)); //ver
...
+ (BOOL) deleteItemForUsername: (NSString *) username andServiceName: (NSString *) serviceName error: (NSError **) error
{
    ...
    CFRelease((__bridge CFTypeRef)(query));
    if (error != nil && status != noErr)
    {
        *error = [NSError errorWithDomain: SFHFKeychainUtilsErrorDomain code: status userInfo: nil];
        return NO;
